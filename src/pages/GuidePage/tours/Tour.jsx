...
import { createTourApi, getTourGuide } from '../../../api/tourAPI'; // Adjust path
...
export default function ManageTourGuide() {
        ...
        const fetchTours = async () => {
            try {
                ...
                const formattedTours = tourData.map(tour => ({
                    ...
                    image: tour.images?.[0] || tour.tourLocations?.[0]?.location?.image || 'https://images.unsplash.com/photo-1469474968028-56623f02e42e?w=300&h=200&fit=crop',
    ...
    const handleAddTour = async () => {
        ...
        newTour.locations.forEach((loc, index) => {
            ...
            if (loc.images.length === 0) missingFields.push(`Hình ảnh địa điểm ${index + 1}`);
        });
    ...
    return (
        <>
            ...
            <div className="container-fluid py-4" style={{ backgroundColor: '#f8f9fa', minHeight: '100vh' }}>
                {loading && <div className="text-center">Đang tải danh sách tour...</div>}
                                    ...
                                    <div className="row g-3">
                                        ...
                                        <div className="col-md-6">
                                            ...
                                            <select
                                                ...
                                                onChange={(e) => setNewTour(prev => ({ ...prev, locationCity: e.target.value }))}
                                            >
                                            ...
                                            {newTour.locations.map((location, index) => (
                                                <div key={index} className="border p-3 mb-3 rounded">
                                                    ...
                                                    <div className="row g-3">
                                                        ...
                                                        <div className="col-md-6">
                                                            <label className="form-label">Hình ảnh địa điểm * (JPG, PNG, GIF, max 5MB)</label>
                                                            <input
                                                                type="file"
                                                                className="form-control"
                                                                ...
                                                                onChange={(e) => {
                                                                    ...
                                                                    if (validFiles.length !== files.length) {
                                                                        setUploadError('Chỉ chấp nhận file JPG, PNG, GIF dưới 5MB');
                                                                    } else {
                                                                        setUploadError(null);
                                                                    }
                                                                    const newLocations = [...newTour.locations];
